...
// 2: Tulip Vase — slim neck, belly curves inward, then top flares outward like a trumpet
export function PotIcon2({ size = 24, color = "currentColor", style, ...props }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" aria-hidden="true" style={style} {...props}>
      <path
        d="M 13 8
        ...
        fill={color}
      />
      <path d="M 11 8 C 15 3 33 3 37 8" stroke={color} strokeWidth="3" strokeLinecap="round" fill="none" />
      <ellipse cx="24" cy="45" rx="6" ry="1.5" fill={color} opacity="0.4" />
      <path d="M 14 30 C 13 34 13 38 15 42" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.22" fill="none" />
    </svg>
  );
}
